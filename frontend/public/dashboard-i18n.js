(() => {
  const ITALIAN_TEXT = new Map(Object.entries({
    ...
    'Требует внимания': 'Da verificare',
    'Ошибка · повторить': 'Errore · riprova',
    'Обновлено частично': 'Aggiornamento parziale',
    'Не все источники ответили. Повторите синхронизацию.': 'Non tutte le fonti hanno risposto. Riprova la sincronizzazione.',
