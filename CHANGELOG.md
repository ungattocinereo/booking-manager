...
- Сокращающийся Booking.com `CLOSED`-маркер больше не наследует начало объединённого периода предыдущего гостя: новый заезд остаётся видимым как операционная Booking‑бронь даже без имени в iCal.
