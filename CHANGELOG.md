...
- Текущие Booking.com брони с гостем самовосстанавливаются по покрывающему iCal-периоду и не архивируются до выезда; короткая неподтверждённая Booking-занятость показывается в операционных представлениях как fallback, но не попадает в статистику.
