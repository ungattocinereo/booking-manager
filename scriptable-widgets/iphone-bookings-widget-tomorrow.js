// Scriptable widget: tomorrow's guest arrivals from Booking Manager.
...
const WIDGET_TITLE = 'Гости завтра';
const ARRIVALS_TITLE = 'Заезды завтра';
const CHECKOUTS_TITLE = 'Выезды';
const OCCUPIED_TITLE = 'Остаются';
const HEADER_SYMBOL = 'sunrise.fill';
...
function renderError(message) {
  ...
  const data = { date: targetDate(), updated_at: new Date().toISOString() };
